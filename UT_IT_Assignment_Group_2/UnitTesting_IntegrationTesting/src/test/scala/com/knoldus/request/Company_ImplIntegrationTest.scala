...
class Company_ImplIntegrationTest extends AnyFlatSpec {
  ...
  "Company is" should "not be created as it already exists in DB" in {
  ...
  "Company is" should "not be created because email id is not valid" in {
  ...
  "Company is" should "not be created because it already exists in DB and email id is not valid" in {
    val knoldusCompany: Company = Company("Knoldus", "knoldusInc@gmailcom", "Noida")
  ...
  "Company is" should "be created" in {
